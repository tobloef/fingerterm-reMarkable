...
{
    zeroChar.c = ' ';
    zeroChar.bgColor = (iUtil && iUtil->whiteTheme()) ? whiteThemeBgColor : defaultBgColor;
    zeroChar.fgColor = (iUtil && iUtil->whiteTheme()) ? whiteThemeFgColor : defaultFgColor;
    zeroChar.attrib = 0;

    escape = -1;

    iTermAttribs.currentFgColor = (iUtil && iUtil->whiteTheme()) ? whiteThemeFgColor : defaultFgColor;
    iTermAttribs.currentBgColor = (iUtil && iUtil->whiteTheme()) ? whiteThemeBgColor : defaultBgColor;
